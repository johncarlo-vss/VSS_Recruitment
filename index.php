...
<div class="body">
              ...
              <div class="col-lg-8 align-self-center mb-4 page-title">
                  ...
                  <div class="col-md-12 mb-2 text-left">
                      <div class="form-group">
                          <div class="input-group col-8" style="display: inline-block">
                            <form class="" action="" method="POST">
                              <input name="searching" type="text" class="form-control" id="filter" style="margin-left:-30px ;background-color: white; border-color: #181821; border-width: 2px; border-radius: 0px; color: #000;" placeholder="Find Vacancies">
                              <input type="button" value="Search" class="btn btn-primary" onclick="searchJob()">
                ...
                <div class="col-md-8"><br>
                  ...
                  <hr class="divider">
                    ...
                    <div id="ajaxajax">
                       ...
                       <!-- Pagination numbers was deleted by Villas 😎👌 -->
                </div>
            </div>
  ...
  <script>
      ...
      function ajaxajax(search, page) {
        ...
        fetch("./ajaxajax.php?search=" + srch + "&page=" + pg).then(response => {
          response.text().then(text => {
            document.getElementById("ajaxajax").innerHTML = text;
          })
        });
      }
